...
int test_krealloc_FF2()
{
	...
	{
		cprintf("test3.1\n");
		ptr = krealloc(NULL, 8 * kilo);
		uint32 * ptr_page_table=NULL;
		struct FrameInfo *frame_info = get_frame_info(ptr_page_directory,(uint32)ptr,&ptr_page_table);		
...
int test_krealloc_FF3()
{
	cprintf("==============================================\n");
	    ...
	    // Case 7.1.1: Next block is allocated and size is equal, then just return NULL
	    {
	        ...
	        if (result != NULL) { correct = 0; cprintf("1.3 Reallocating to the same size should return NULL\n"); }
	    ...
	    // Case 7.2.1: Next block is free and size is equal, then just return NULL
	    {
	        ...
	        if (result != NULL) { correct = 0; cprintf("4.2 Reallocating to the same size should return NULL\n"); }
